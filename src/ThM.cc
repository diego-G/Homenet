...
void ThM::handleMessage(cMessage *msg) {
...
void ThM::recordDelay(Values *homenetObject) {
...
void ThM::updateStats(simtime_t now, unsigned long bits) {
	numPackets++;
	numBits += bits;
...
void ThM::beginNewInterval(simtime_t now) {
